...
!!! info "Информация"
    Начиная с 18 мая 2026 года, участники сети переключили свои узлы на предустановленный модем MediumFast. Для получения дополнительной информации о настройке подключенных узлов см. [наше руководство по настройке](/guides/start).
